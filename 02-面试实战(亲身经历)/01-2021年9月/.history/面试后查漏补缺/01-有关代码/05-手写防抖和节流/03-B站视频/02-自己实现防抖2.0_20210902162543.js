 ...
 * @LastEditTime: 2021-09-02 16:25:43
...
function debounce(func, wait,isImmediate) {
  ...
  return function () {
    ...
    //   console.log("debounce函数返回值的参数", arguments);
    let _this = this;
    //改变执行函数内部this的指向
    //   注意：使用箭头函数就不用在定时器上定义this指向了，直接在执行函数后面改变他的this执行就行——？不对，好像不行
    let args = arguments;
    console.log("返回值中的arguments", arguments);
    console.log("返回值中的this", this);
...
function doSomething(e) {
  console.log("doSomething中的arguments", arguments);
